<template>
    <nav :class="paginateClass"
         role="navigation"
         aria-label="pagination"
         v-if="!noLiSurround">

        <div v-if="firstLastButton"
             :class="[pageClass, firstPageSelected() ? disabledClass : '']">
            <a @click="selectFirstPage()"
               @keyup.enter="selectFirstPage()"
               :class="pageLinkClass">{{ firstButtonText }}</a>
        </div>
    ...
    <div :class="[nextClass, lastPageSelected() ? disabledClass : '']">
      <a @click="nextPage()"
    ...
    <div :class="paginateListClass" v-else>
        ...
        <a v-if="firstLastButton"
           @click="selectLastPage()"
           @keyup.enter="selectLastPage()"
           :class="[pageLinkClass, lastPageSelected() ? disabledClass : '']" tabindex="0">{{ lastButtonText }}
        </a>
      </div>
    </nav>
</template>
...
export default {
  props: {
    ...
    activeClass: {
      type: String,
      default: 'pagination-link is-current'
    },
    disabledClass: {
      type: String,
      default: 'pagination-previous'
